...
// 删除品牌操作 /admin/product/baseTrademark/remove/{id}  delete  携带id
export const reqDeleteTradeMark = (id) => request({ url:`/admin/product/baseTrademark/remove/${id}`,method:'dele'})