      ...
      <el-form-item label="平台属性">
        <el-form :inline="true" ref="form" label-width="80px">
          <el-form-item
            ...
            :key="attr.id"
          >
            <el-select placeholder="请选择" value="attr.attrValueList">
              <el-option label="label" value="value" v-for="(attrValue,index) in attr.attrValueList" :key="attrValue"></el-option>
            </el-select>
          </el-form-item>
        </el-form>
      </el-form-item>
