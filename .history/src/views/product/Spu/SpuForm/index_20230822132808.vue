    ...
    <el-form ref="form" label-width="80px" :model="spu">
      ...
      <el-form-item label="销售属性">
        ...
        <el-table :data="data" style="width: 100%; margin-top: 15x" border>
          <!-- 展示当前spu属于自己的销售属性 -->
          <el-table-column type="index" label="label" width="80" align="center" :data="spu.spuSaleAttrList">
          </el-table-column>
          <el-table-column prop="saleAttrName" label="属性名" width="width">
          </el-table-column>
          <el-table-column prop="saleAttrValueName" label="属性值列表" width="width">
          </el-table-column>
