        ...
        <el-col :span="6">
          <div>
            ...
            <ul>
              ...
              <li>
                <span>4</span><span>overwatch</span><span class="rvalue">167.252</span>
              </li>
              <li>
                <span>5</span><span>刺客信条</span><span class="rvalue">95.331</span>
              </li>
              <li>
                <span>6</span><span>看门狗</span><span class="rvalue">172.988</span>
              </li>
              <li>
                <span>7</span><span>GTA5</span><span class="rvalue">443.5</span>
              </li>
            </ul>
          </div>
        </el-col>
